...
type ServerInterface interface {
	...
	GetUsersUserIdTasks(ctx echo.Context, userId int64) error
}
...
type GetUsersUserIdTasks500Response struct {
}

func (response GetUsersUserIdTasks500Response) VisitGetUsersUserIdTasksResponse(w http.ResponseWriter) error {
	w.WriteHeader(500)
	return nil
}
...
func (sh *strictHandler) GetUsersUserIdTasks(ctx echo.Context, userId int64) error {
